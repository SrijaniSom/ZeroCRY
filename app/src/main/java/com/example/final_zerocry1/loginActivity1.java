...
public class loginActivity1 extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
            ...
            public void onClick(View v)
            {
                ...
                auth.signInWithEmailAndPassword(mail,password).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task)
                    {
                        ...
                        {
                            startActivity(new Intent(loginActivity1.this, com.example.final_zerocry1.purpActivity1.class));
        ...
        createview.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v)
            {
                startActivity(new Intent(loginActivity1.this, com.example.final_zerocry1.regActivity.class));
            }
        });
