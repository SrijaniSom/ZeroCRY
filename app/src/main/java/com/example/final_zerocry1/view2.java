...
import com.example.final_zerocry1.DataBaseHelper1;
import com.example.final_zerocry1.ThreeColumnAdapter;
...
public class view2 extends AppCompatActivity
{
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState)
    {
        ...
        db=new com.example.final_zerocry1.DataBaseHelper1(this);
...

        {
            ...
            adapter =new com.example.final_zerocry1.ThreeColumnAdapter(this,R.layout.content_layout,userList);
