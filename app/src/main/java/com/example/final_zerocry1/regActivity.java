...
public class regActivity extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        {
            startActivity(new Intent(regActivity.this, com.example.final_zerocry1.loginActivity1.class));
            ...
            public void onClick(View v)
            {
                ...
                fauth.createUserWithEmailAndPassword(mail,password).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task)
                    {
                        ...
                        {
                            startActivity(new Intent(regActivity.this, com.example.final_zerocry1.purpActivity1.class));
